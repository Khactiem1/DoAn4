    ...
    <header id="header"
        ...
        <div class="navbar-nav-wrap">
            ...
            <div class="navbar-nav-wrap-content-right">
                <a href="{{route('ad.logout')}}">Logout</a>
            </div>
            ...
            <div class="navbar-nav-wrap-content-right">
                ...
                <ul class="navbar-nav align-items-center flex-row">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="avatar avatar-sm avatar-circle">
                                                                    <img class="avatar-img"
                                                                         src="{{ asset('Admin\assets\img\160x160\img3.jpg')}}"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-auto position-static">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="avatar avatar-sm avatar-circle">
                                                                    <img class="avatar-img"
                                                                         src="{{ asset('Admin\assets\img\160x160\img10.jpg')}}"
                                                                         alt="Image Description">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-auto position-static">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="avatar avatar-sm avatar-circle">
                                                                    <img class="avatar-img"
                                                                         src="{{ asset('Admin\assets\svg\brands\google.svg')}}"
                                                                         alt="Image Description">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-auto position-static">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="avatar avatar-sm avatar-circle">
                                                                    <img class="avatar-img"
                                                                         src="{{ asset('Admin\assets\img\160x160\img7.jpg')}}"
                                                                         alt="Image Description">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-auto position-static">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="avatar avatar-sm avatar-circle">
                                                                    <img class="avatar-img"
                                                                         src="{{ asset('Admin\assets\img\160x160\img5.jpg')}}"
                                                                         alt="Image Description">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-auto position-static">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="avatar avatar-sm avatar-circle">
                                                                    <img class="avatar-img"
                                                                         src="{{ asset('Admin\assets\img\160x160\img8.jpg')}}"
                                                                         alt="Image Description">
                                                                </div>
                                                            </div>
                                                        </div>
                 ...
                 "type": "css-animation"
                      ...
                      <span class="mr-3">
                        <img class="avatar avatar-xs avatar-4by3" src="{{ asset('Admin\assets\svg\brands\atlassian.svg')}}"
                             alt="Image Description">
                      </span>
                                        ...
                                        <a class="nav-link" href="#">
                                            <div class="media align-items-center">
                      <span class="mr-3">
                        <img class="avatar avatar-xs avatar-4by3" src="{{ asset('Admin\assets\svg\brands\slack.svg')}}"
                             alt="Image Description">
                      </span>
                                                <div class="media-body text-truncate">
                                        ...
                                        <a class="nav-link" href="#">
                                            <div class="media align-items-center">
                      <span class="mr-3">
                        <img class="avatar avatar-xs avatar-4by3" src="{{ asset('Admin\assets\svg\brands\google-webdev.svg')}}"
                             alt="Image Description">
                      </span>
                                                <div class="media-body text-truncate">
                                        ...
                                        <a class="nav-link" href="#">
                                            <div class="media align-items-center">
                      <span class="mr-3">
                        <img class="avatar avatar-xs avatar-4by3" src="{{ asset('Admin\assets\svg\brands\frontapp.svg')}}"
                             alt="Image Description">
                      </span>
                                                <div class="media-body text-truncate">
                                                    <span class="h5 mb-0">Frontapp</span>
                                                    <span
                                                        class="d-block font-size-sm text-body">The inbox for teams</span>
                                                </div>
                                            </div>
                                        </a>
                      ...
                      <span class="mr-3">
                        <img class="avatar avatar-xs avatar-4by3"
                             src="{{ asset('Admin\assets\svg\illustrations\review-rating-shield.svg')}}" alt="Image Description">
                      </span>
                                                <div class="media-body text-truncate">
                ...
                "smartPositionOff": true
                 ...
                 "type": "css-animation"
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img" src="{{ asset('Admin\assets\img\160x160\img6.jpg')}}" alt="Image Description">
                                ...
                                <div class="dropdown-item-text">
                                    <div class="media align-items-center">
                                        <div class="avatar avatar-sm avatar-circle mr-2">
                                            <img class="avatar-img" src="{{ asset('Admin\assets\img\160x160\img6.jpg')}}"
                                                 alt="Image Description">
                                        </div>
                    ...
                    <ul class="navbar-nav flex-grow-1">
                        ...
                        <li class="hs-has-sub-menu">
                            <a id="appsNavDropdown"
                               class="hs-mega-menu-invoker navbar-nav-link nav-link nav-link-toggle" href="javascript:;"
                               aria-haspopup="true" aria-expanded="false" aria-labelledby="navLinkappsNavDropdown">
            ...
            <div class="container-fluid">
                <div class="navbar-nav-wrap">
                    <div class="navbar-brand-wrapper">
                        <!-- Logo -->
                        <a class="navbar-brand" href="index.html" aria-label="Front">
                            <img class="navbar-brand-logo" src="{{ asset('Admin\assets\svg\logos\logo-white.svg')}}" alt="Logo">
                        </a>
                        <!-- End Logo -->
                    </div>
                      ...
                      <span class="icon icon-xs icon-soft-dark icon-circle mr-2">
                        <i class="tio-paint-bucket"></i>
                                        ...
                                        <a class="dropdown-item my-2" href="index.html">
                                            <div class="media align-items-center">
                                                <img class="avatar avatar-xs avatar-circle mr-2"
                                                     src="{{ asset('Admin\assets\img\160x160\img10.jpg')}}" alt="Image Description">
                                                <div class="media-body text-truncate">
                                        ...
                                        <a class="dropdown-item my-2" href="index.html">
                                            <div class="media align-items-center">
                                                <img class="avatar avatar-xs avatar-circle mr-2"
                                                     src="{{ asset('Admin\assets\img\160x160\img3.jpg')}}" alt="Image Description">
                                                <div class="media-body text-truncate">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col ml-n3">
                                                                    ...
                                                                    <p class="card-text font-size-sm">Start using forms
                                                                        to capture the information of prospects visiting
                                                                        your Google website</p>
                                                                </div>
                                                                <small class="col-auto text-muted text-cap">17dy</small>
                                                            </div>
                                                            <a class="stretched-link" href="#"></a>
                                        ...
                                        <div class="card-body card-body-height">
                                            ...
                                            <div class="nav nav-pills flex-column">
                                                <a class="nav-link" href="#">
                                                    <div class="media align-items-center">
                          <span class="mr-3">
                            <img class="avatar avatar-xs" src="{{ asset('Admin\assets\svg\brands\atlassian.svg')}}" alt="Image Description">
                          </span>
                                                        <div class="media-body text-truncate">
                                                            <span class="h5 mb-0">Atlassian</span>
                                                            <span class="d-block font-size-sm text-body">Security and control across Cloud</span>
                                                ...
                                                <a class="nav-link" href="#">
                                                    <div class="media align-items-center">
                          <span class="mr-3">
                            <img class="avatar avatar-xs" src="{{ asset('Admin\assets\svg\brands\slack.svg')}}" alt="Image Description">
                          </span>
                                                        <div class="media-body text-truncate">
                                                            <span class="h5 mb-0">Slack <span
                                                                    class="badge badge-primary badge-pill text-uppercase ml-1">Try</span></span>
                                                ...
                                                <a class="nav-link" href="#">
                                                    <div class="media align-items-center">
                          <span class="mr-3">
                            <img class="avatar avatar-xs" src="{{ asset('Admin\assets\svg\brands\frontapp.svg')}}" alt="Image Description">
                          </span>
                                                        <div class="media-body text-truncate">
                                                            <span class="h5 mb-0">Frontapp</span>
                                                ...
                                                <a class="nav-link" href="#">
                                                    <div class="media align-items-center">
                          <span class="mr-3">
                            <img class="avatar avatar-xs" src="{{ asset('Admin\assets\svg\illustrations\review-rating-shield.svg')}}"
                                 alt="Image Description">
                          </span>
                                                        <div class="media-body text-truncate">
                                                            <span class="h5 mb-0">HS Support</span>
