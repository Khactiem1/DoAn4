            ...
            <div class="navbar-vertical-footer-offset">
                <div class="navbar-brand-wrapper justify-content-between">
                    ...
                    <a class="navbar-brand" href="#" aria-label="Front">
                        ...
                        <img class="navbar-brand-logo-mini" src="{{ asset('Admin\assets\svg\logos\logo-short.svg')}}" alt="Logo">
                    </a>
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="navbar-vertical-aside-has-menu ">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                <li class="nav-item">
                                    <a class="nav-link " href="{{route('categories.index')}}" title="Quản lý danh mục sản phẩm">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">Quản lý danh mục sản phẩm</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="{{route('product.index')}}" title="Quản lý sản phẩm">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">Quản lý sản phẩm</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="{{route('trademark.index')}}" title="Quản lý thương hiệu">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">Quản lý thương hiệu</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="navbar-vertical-aside-has-menu ">
                            <a class="nav-link" href="{{route('discount.index')}}"
                               title="Quản lí slider">
                                <i class="tio-apps nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Quản lí mã giảm giá</span>
                            </a>
                        </li>
                        <li class="navbar-vertical-aside-has-menu ">
                            <a class="nav-link" href="{{route('slider.index')}}"
                               title="Quản lí slider">
                                <i class="tio-apps nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Quản lí slider</span>
                            </a>
                        </li>
                        <!-- End Apps -->
                    </ul>
        ...
        <div class="navbar-vertical-container">
            <div class="navbar-brand d-flex justify-content-center">
                ...
                <a class="navbar-brand" href="index.html" aria-label="Front">
                    <img class="navbar-brand-logo-short" src="{{ asset('Admin\assets\svg\logos\logo-short.svg')}}" alt="Logo">
                </a>
            ...
            <div class="navbar-vertical-content">
                <ul class="navbar-nav nav-compact">
                    ...
                    <li class="navbar-vertical-aside-has-menu nav-item">
                        <a class="js-navbar-vertical-aside-menu-link nav-link " href="javascript:;" title="Tranng tổng quan">
                            <i class="tio-home-vs-1-outlined nav-icon"></i>
                            <span class="nav-compact-title text-truncate">Tranng tổng quan</span>
                        </a>
