...
@section('javascriptForm')
    ...
    <script src="{{ asset('app\controller\admin\sliderController.js')}}"></script>
        ...
        $(document).on('ready', function () {
            ...
            input.forEach((blurs,index) =>{
                blurs.onblur = function(){
                    if(index == 0){
                        function tests(){
                            return input[0].value.trim().length >= 1 ? undefined :  `Hãy nhập tên slider`;
                        }
                        if(tests() == null){
                        }
                        else{
...
@section('content')
    <div ng-app="my-app">
        <!-- Content -->
        <div class="content container-fluid" ng-controller="sliderController">
            <!-- Page Header -->
            <div>
                <div class="row align-items-center mb-3">
                    <div class="col-sm mb-2 mb-sm-0">
                        <h1 class="page-header-title">Slider <span class="badge badge-soft-dark ml-2">@{{ amount }}</span></h1>
                    </div>

                    <div class="col-sm-auto">
                        <a class="btn btn-primary" ng-click="modal('add')"  data-toggle="modal" data-target="#exampleModal1">Thêm slider</a>
                    </div>
                </div>
                <!-- End Row -->
            </div>
            ...
            <div style="overflow-x: auto" class="card">
                ...
                <table class="table">
                    ...
                    <tr>
                        <th scope="col">STT</th>
                        <th title="Click để sắp xếp" style="cursor: pointer" scope="col" ng-click="sort('name')">Slider
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="NameCategory" class="input-label">Tên slider</label>
                                <div class="input-group input-group-merge">
                                    <input id="name" type="text" class="form-control auth-form__input" ng-model="trademark.name" placeholder="Nhập tên slider">
                            ...
                            <!-- Input Group -->
                            <div class="form-group">
                                <img id="trademark-image">
                                <label class="btn btn-sm btn-primary transition-3d-hover custom-file-btn" for="fileAttachmentBtn">
                                    <span id="customFileExample5">Hình ảnh</span>
                                    <input accept="image/*" id="fileAttachmentBtn" fileread="trademark.path" name="custom-file" type="file" class="js-file-attach custom-file-btn-input"
            ...
            <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            Bạn có chắc chắn muốn xoá slider "@{{name}}"
                        </div>
                        <div class="modal-footer">
