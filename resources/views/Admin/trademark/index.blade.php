...
@section('javascriptForm')
    ...
    <script src="{{ asset('app\controller\admin\trademarkController.js')}}"></script>
        ...
        $(document).on('ready', function () {
            ...
            input.forEach((blurs,index) =>{
                blurs.onblur = function(){
                    if(index == 0){
                        function tests(){
                            return input[0].value.trim().length >= 1 ? undefined :  `Hãy nhập tên thương hiệu`;
                        }
                        if(tests() == null){
                        }
                        else{
        ...
        <div class="content container-fluid" ng-controller="categoryController">
            ...
            <div>
                <div class="row align-items-center mb-3">
                    <div class="col-sm mb-2 mb-sm-0">
                        <h1 class="page-header-title">Thương hiệu sản phẩm <span class="badge badge-soft-dark ml-2">@{{ amount }}</span></h1>
                    </div>

                    <div class="col-sm-auto">
                        <a class="btn btn-primary" ng-click="modal('add')"  data-toggle="modal" data-target="#exampleModal1">Thêm thương hiệu</a>
                    </div>
                </div>
                <!-- End Row -->
            </div>
            ...
            <div style="overflow-x: auto" class="card">
                ...
                <table class="table">
                    ...
                    <tr>
                        <th scope="col">STT</th>
                        <th title="Click để sắp xếp" style="cursor: pointer" scope="col" ng-click="sort('name')">Thương hiệu
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="NameCategory" class="input-label">Tên thương hiệu</label>
                                <div class="input-group input-group-merge">
                                    <input id="name" type="text" class="form-control auth-form__input" ng-model="trademark.name" placeholder="Nhập tên thương hiệu">
            ...
            <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            Bạn có chắc chắn muốn xoá thương hiệu "@{{name}}"
                        </div>
                        <div class="modal-footer">
