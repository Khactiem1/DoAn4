function active__messageNotification(message, type) {
    ...
    if (type == true) {
        ...
        toast.innerHTML = `<i class="tio-verified tio-lg new__notification-icon new__notification-iconTrue"></i>
                                        <span>${message}</span>
                    <i class="tio-clear tio-lg new__notification-close"></i>`
        content__notification.appendChild(toast);
    }
    else if (type == false) {
        toast.classList.add('new__notification');
        toast.classList.add('new__notification-error');
        toast.innerHTML = `<i class="tio-warning mt-1 mr-1 new__notification-icon new__notification-iconFalse"></i>
                                        <span>${message}</span>
                    <i class="tio-clear tio-lg new__notification-close"></i>`
        content__notification.appendChild(toast);
    }
